...
Цель: Превратить описание проекта Excel Clipboard Masker в понятную инженерную постановку для разработки demo-репозитория.
...
- Ограничения: Windows/desktop-сценарий, Python, без сложной инфраструктуры, без GUI, без системных хуков, использовать polling буфера обмена, решение должно быть небольшим и понятным для публичного demo.
- Домен: automation / clipboard utility / internal data protection demo.
...
- Формат разработки: Один исполнитель, публичное demo.
...
- Ограничения: Минимум файлов, без framework, без БД, понятная структура для публичного demo и unit-тестов.
