...
**Бизнес-задача:** В рабочих процессах с Excel часто возникает необходимость копировать табличные данные для пересылки, согласования или переноса в другие системы, не раскрывая при этом реальные чувствительные суммы и числовые показатели. Нужен способ маскировать такие данные через `копирование части таблицы → и ее вставивки`, без отдельной ручной подготовки таблицы.
